...
class CustomerPurchaseInfoHelper {
  static CustomerPurchasesInfo fromRevenueCat(CustomerInfo customerInfo) {
    ...
    customerInfo.entitlements.all.forEach((id, info) {
      subs.add(CustomerPurchaseInfo(
        productId: id,
        originalPurchaseDate:
         DateTime.tryParse(info.originalPurchaseDate),
    ...
    return CustomerPurchasesInfo(
      ...
      originalPurchaseDate: customerInfo.originalPurchaseDate !=null ?DateTime.tryParse(customerInfo.originalPurchaseDate!): null,
      latestExpirationDate: customerInfo.latestExpirationDate !=null ?DateTime.tryParse(customerInfo.latestExpirationDate!): null,
      purchases: subs,
